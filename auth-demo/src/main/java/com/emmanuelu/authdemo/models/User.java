...
public class User {
	...
	//in the database and that's why there's a @Transient annotation above it
	Any variable you don't need to be saved in the database should have @Transient above it*/
